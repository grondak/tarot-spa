...
6. Record content-safe evidence in the Story 3.8 verification log: Session ID may be abbreviated or omitted; include lifecycle transition, execution status, counter deltas, worker version, and alarm disposition.
